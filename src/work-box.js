...
const WorkBox = (params) => {
  const [size, setSize] = useCallback(useState(params.size))
      ...
      <View style={styles.bottom}>
        ...
        >
          ...
          >
            <Image
              source={github}
              style={[styles.img, hover ? { tintColor: 'darkorange' } : '']}
            />
          </View>
          <Text
            style={[
              styles.textLink,
              hover
                ? { backgroundColor: 'lightgrey', color: 'darkorange' }
                : '',
            ]}
          >
            {' '}
