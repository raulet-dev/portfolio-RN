...
const Skills = (props, {changePosition}) => {
  ...
  const styles = StyleSheet.create({
    ...
    text: {
      ...
      fontSize: (orientation === 'landscape')?0.03*useWindowSize().height:0.032*useWindowSize().width,
      color: '#333',
      },
    textTitle: {
      textAlign: 'left',
      fontFamily: 'LibreBaskerville_400Regular',
      fontSize: (orientation === 'landscape')?0.035*useWindowSize().height:0.035*useWindowSize().width,
      color: '#333',
      },
    contrast: {
      color: 'darkorange'
  ...
  return (
    <View style={styles.container}>
      <View style={styles.titleBlock}>
        <View style={styles.spaceNO}>

        </View>
        <View style={styles.titleNo}>
          <Text style={styles.textTitle}><Text style={[styles.textTitle, styles.contrast]}>Comfortable</Text> with:</Text>
        </View>
        <View style={styles.titleNo}>
      ...
      <View style={styles.contentBlock}>
        ...
        <View style={styles.content}>
            ...
            <Text style={styles.text}>- <Text style={[styles.text, styles.contrast]}>C#</Text></Text>
            <Text style={styles.text}>- HTML</Text>
            <Text style={styles.text}>- CSS</Text>
        </View>
        <View style={styles.content}>
          <Text style={styles.text}>- <Text style={[styles.text, styles.contrast]}>JavaScript</Text></Text>
      ...
      <View style={styles.titleBlock}>
        ...
        <View style={styles.titleLine}>
          <Text style={styles.textTitle}><Text style={[styles.textTitle, styles.contrast]}>Knowledge</Text> of:</Text>
        </View>
        <View style={styles.titleLine}>
      ...
      <View style={styles.contentBlock}>
        ...
        <View style={styles.content}>
          <Text style={styles.text}>- <Text style={[styles.text, styles.contrast]}>NodeJS</Text></Text>
          <Text style={styles.text}>- <Text style={[styles.text, styles.contrast]}>React Native</Text></Text>
      ...
      <View style={styles.titleBlock}>
        ...
        <View style={styles.titleLine}>
          <Text style={styles.textTitle}><Text style={[styles.textTitle, styles.contrast]}>Certificate</Text> in:</Text>
        </View>
        <View style={styles.spaceLine}>
      ...
      <View style={styles.contentBlock}>
        ...
        <View style={styles.content}>
          ...
          <Text style={styles.text}>- <Text style={[styles.text, styles.contrast]}>English</Text></Text>
